...
export default function Contact() {
  ...
  return (
    <section id="contact" className="min-h-screen flex flex-col justify-center items-center px-8 py-32 relative overflow-hidden contact-bg">
      {/* Background elements */}
      ...
      <div className="max-w-6xl mx-auto text-center animate-fade-in">
        <h2 className="text-6xl lg:text-7xl font-extrabold text-white leading-tight animate-fade-in mb-8">
          get in touch
        </h2>
          ...
          {contactMethods.map((method, index) => {
            ...
            return (
              <a 
                ...
                className="group"
              >
                <div className="code-glow bg-gradient-to-r from-dark-gray to-medium-gray p-6 rounded-lg border border-code-blue hover:border-terminal-green transition-all duration-300 h-full flex flex-col">
                  <div className="flex items-start mb-4">
                    <IconComponent size={24} className="text-code-blue group-hover:text-terminal-green transition-colors mr-4 mt-1 flex-shrink-0" />
                    <div className="flex-1">
                      <h3 className="text-code-blue text-lg font-semibold group-hover:text-terminal-green transition-colors mb-1">
                        {method.label}
                      </h3>
        ...
        {/* Final message */}
        <div className="terminal-bg p-12 rounded-lg">
          <h3 className=" text-poetry-gold text-3xl mb-8 italic">

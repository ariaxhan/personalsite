...
export default function About() {
  return (
    <section
      id="about"
      className="min-h-screen flex flex-col justify-center items-center px-8 py-32 relative overflow-hidden about-bg"
    >
      {/* Background elements */}
      ...
      <div className="max-w-6xl mx-auto text-center animate-fade-in">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            {/* heycontext.co */}
            <div className="code-glow bg-gradient-to-r from-dark-gray to-medium-gray p-8 rounded-lg border border-code-blue">
              <h3 className=" text-code-blue text-2xl mb-4">heycontext.co</h3>
            ...
            {/* The Convergence */}
            <div className="bg-gradient-to-r from-dark-gray to-medium-gray p-8 rounded-lg border border-accent-purple">
              <h3 className=" text-accent-purple text-2xl mb-4">The Convergence</h3>
              <p className="text-gray-300 mb-4">

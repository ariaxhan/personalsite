...
const catalogCards: CatalogCard[] = [
  {
    ...
    category: "ENTITY",
    title: "Aria Han",
    content: "AI systems architect and writer. Three-time founder. Building KERNEL, llm-bench, and portable agent skills. San Francisco.",
    tags: ["architect", "writer", "founder", "san francisco", "agents"],
    link: "/about",
    color: "cognition",
  },
  {
  ...
  },
  {
    ...
    category: "OPEN SOURCE",
    title: "llm-bench",
    content: "Model Familiarity Engine. Onboards language models through real work, redacted replay, floor-tested judging, and evidence-backed model cards.",
    tags: ["model familiarity", "evals", "routing", "open source"],
    link: "/open-source",
    color: "emergence",
  },
  {

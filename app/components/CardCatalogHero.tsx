...
const catalogCards: CatalogCard[] = [
  ...
  },
  {
    ...
    content: "Darwin · Convergence · Content Creator Connector · TheraVoice · HotAgents · Freetime",
  ...
  },
  {
    ...
    category: "OPEN SOURCE",
    title: "Vector Native",
    content: "A2A communication protocol. Semantic density for agent coordination.",
    tags: ["protocol", "a2a", "open source"],
    link: "/open-source",
    color: "emergence",
  },
  {
    ...
    content: "Self-evolving agent framework—agents that get better every run via a reinforcement-learning loop. Published to PyPI as armature-ai.",

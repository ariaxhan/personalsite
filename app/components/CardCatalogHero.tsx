...
const catalogCards: CatalogCard[] = [
  {
    ...
    category: "ENTITY",
    title: "Aria Han",
    content: "AI systems architect and writer. Three-time founder. Building KERNEL, llm-bench, model-familiarity-engine, and portable agent skills. Los Angeles.",
    tags: ["architect", "writer", "founder", "los angeles", "agents"],
    link: "/about",
    color: "cognition",
  },
  {
  ...
  },
  {
    id: "hackathons",
    category: "EVIDENCE",
    title: "6 Hackathon Wins",
    content: "Darwin · Armature · Content Creator Connector · TheraVoice · HotAgents · Freetime",
    tags: ["hackathon", "aws", "google cloud"],
    link: "/evidence",
    color: "memory",
  },
  {
    ...
    content: "Curated library of 34 portable skills for Claude, Codex, and other agents: verification, planning, research, writing, work management, code engineering, and shipping.",
    tags: ["skills", "claude", "codex", "agents", "open source"],
    link: "/open-source",
    color: "memory",
  },
  {
    ...
    category: "OPEN SOURCE",
    title: "llm-bench",
    content: "Practical workflow benchmarks for local and API-hosted language models, with programmatic verifiers and provider adapters.",
    tags: ["benchmarks", "evals", "verifiers", "open source"],
    link: "/open-source",
    color: "emergence",
  },
  {
    id: "model-familiarity-engine",
    category: "OPEN SOURCE",
    title: "model-familiarity-engine",
    content: "Evidence-backed model cards from replayed known-outcome tasks and observed model behavior. Models earn responsibilities through evidence.",
    tags: ["model familiarity", "routing", "model cards", "open source"],
    link: "/open-source",
    color: "cognition",
  },
  {
    ...
    category: "OPEN SOURCE",
    title: "metabrain",
    content: "SQLite memory layer for AI agents that learns what works—patterns graduate to proven preferences through a built-in experiment loop. Zero dependencies. On PyPI.",
    tags: ["memory", "agents", "pypi", "open source"],
    link: "/open-source",
    color: "data",
  },
  {
    ...
    category: "OPEN SOURCE",
    title: "KERNEL",
    content: "Claude Code that learns from itself. Persistent memory, multi-agent orchestration, experiment engine, on-demand skills, and validation gates.",
  ...
  },
  {
    ...
    category: "TRAJECTORY",
    title: "3 Companies",
    content: "PersistOS · Divertissement · Brink Labs.",
  ...
  },
  {
    ...
    content: "Articles on agent coordination, memory systems, and AI architecture.",
  ...
  },
  {
    ...
    category: "ARTIFACT",
    title: "SUBSTRATE",
    content: "Computational poetry gallery. Claude Code agents generate abstract, interactive HTML pieces daily. 70+ pieces and counting.",
    tags: ["generative", "claude code", "daily"],
    link: "https://substrate.pages.dev",
    color: "emergence",
    external: true,
  },
];
